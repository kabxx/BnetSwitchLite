...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex size-8 shrink-0 rounded-full select-none data-[size=lg]:size-9 data-[size=sm]:size-6",
        className
      )}
      {...props}
    />
  ...
  return (
    <span
      ...
      className={cn(
        ...
        "group-data-[size=lg]/avatar:-right-px group-data-[size=lg]/avatar:-bottom-px group-data-[size=lg]/avatar:size-3 group-data-[size=lg]/avatar:[&>svg]:size-2",
        className
      )}
      {...props}
    />
